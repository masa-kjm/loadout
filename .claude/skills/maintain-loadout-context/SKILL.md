...
description: Maintain Loadout v0.5 documentation and project skills without changing their authority boundaries. Use when updating docs, navigation, agent instructions, or source skills and their generated discovery copies.
---

# Maintain Loadout v0.5 Context

Keep documentation and project skills accurate, discoverable, and derived from the authoritative v0.5 contracts. Do not use this skill to choose an unresolved product behavior or to implement a code-only change with no documentation or skill impact.
...
- Keep `AGENTS.md` and `CONTRIBUTING.md` as derived guidance. They may explain authority and workflow but must not redefine v0.5 behavior.
