...
| `docs/README.md` | Documentation authority, v0.4 scope, and reading routes | A replacement for an architecture or specification contract |
...
| `docs/future/` | Non-binding constraints and promotion considerations for later work | A v0.4 behavior change |

When a canonical document changes, update its direct navigation and dependent summary only when necessary:

- update `docs/README.md` when a documentation layer, page inventory, authority, or v0.4 scope changes;
