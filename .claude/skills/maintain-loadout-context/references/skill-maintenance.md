...
Skills are derived guidance. They must not create a v0.4 contract, authorize GitHub or Git mutation, expand a task's scope, or override `docs/architecture/` or `docs/specs/`.
