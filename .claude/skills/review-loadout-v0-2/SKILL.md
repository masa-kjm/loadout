...
description: Review Loadout v0.3 changes and pull requests against authoritative contracts, architecture boundaries, safety invariants, and required test evidence. Use especially for filesystem mutation, ownership, recovery, paths, schema, state, or CLI changes.
---

# Review Loadout v0.3 Changes
