...
| Documentation | `docs/<description>` | `docs/v0.4-inspection` |
| Refactoring | `refactor/<description>` | `refactor/planner-inputs` |
| Tests | `test/<description>` | `test/recovery-contract` |
| Tooling or maintenance | `chore/<description>` | `chore/v0.4-ci` |
| Release preparation | `release/vX.Y.Z` | `release/v0.4.0` |
...
The release contract is implemented by `.github/workflows/release.yml`.
