...
This directory records design work that is explicitly outside v0.4.0.
...
They must not weaken or reinterpret the v0.4.0 architecture or specifications.
...
- [Inspection and Authoring Commands](inspection-and-authoring.md) considers future authoring and inspection extensions beyond the v0.4.0 command surface.
