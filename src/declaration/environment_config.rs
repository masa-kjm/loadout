...
use crate::declaration::schema::{EnvironmentSchemaVersionV2, deserialize_optional_string};
...
pub(crate) struct EnvironmentConfig {
    #[allow(dead_code)]
    schema_version: EnvironmentSchemaVersionV2,
...
impl EnvironmentConfig {
    /// Parses and structurally validates only the version-2 environment schema.
    ///
...
/// The only supported store declaration shape.
#[derive(Clone, Debug, Deserialize, Eq, PartialEq)]
#[serde(deny_unknown_fields)]
pub(crate) struct LocalStore {
    ...
    properties: LocalStoreProperties,
}

/// Type-specific fields for a local store.
#[derive(Clone, Debug, Deserialize, Eq, PartialEq)]
#[serde(deny_unknown_fields)]
struct LocalStoreProperties {
    path: String,
}
...
/// The only supported environment store type in v0.3.0.
...
mod tests {
    ...
    #[test]
    fn environment_config_accepts_version_two_and_preserves_raw_declarations() {
    ...
    fn environment_config_rejects_schema_errors_at_every_object_level() {
        for (fixture, yaml) in [
            ...
            (
                "missing local-store path",
                "schema_version: 2\nprofile_discovery:\n  paths: [./profiles]\nstores:\n  dotfiles:\n    type: local\n    properties: {}\n",
            ),
            (
                "unknown local-store property",
                "schema_version: 2\nprofile_discovery:\n  paths: [./profiles]\nstores:\n  dotfiles:\n    type: local\n    properties:\n      path: .\n      writable: false\n",
            ),
            (
